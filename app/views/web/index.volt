    ...
    <div class="mainbag">
        <div vs-anchor="view-1" class="mainview view1">
            ...
            <div class="row contact1">
                <div class="col-md-8 main-block option contact-div">
                    <button type="button" class='btn btn-contact'>Contáctame</button>
                    <label style='padding-left:5%' class='description'>o</label>
                </div>
                <div class="col-md-1 main-block option">
                ...
                <div class="col-md-2 main-block option" style='padding-left: 5%;'>
                    <label class='txt-whatsapp'>Inicia una conversación</label>
                </div>
            </div>
